...
typedef struct {
	...
	phys_bytes OemStringPtr; 			/* VbeFarPtr to OEM String */
	uint8_t Capabilities[4];		/* Capabilities of graphics controller */
	phys_bytes VideoModePtr; 			/* VbeFarPtr to VideoModeList */
	uint16_t TotalMemory; 			/* Number of 64kb memory blocks */
	uint16_t OemSoftwareRev; 		/* VBE implementation Software revision */
	phys_bytes OemVendorNamePtr; 		/* VbeFarPtr to Vendor Name String */
	phys_bytes OemProductNamePtr; 	/* VbeFarPtr to Product Name String */
	phys_bytes OemProductRevPtr; 		/* VbeFarPtr to Product Revision String */
...
/*
 * Similar to the previous function. Returns VBE Controller Information by calling
 * VBE function 0x00 and unpacks the VbeInfoBlock struct returned by that function.
 */
